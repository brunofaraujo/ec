...
import { NbAuthComponent } from './components';

import { NbAuthBlockComponent } from './components';
import { NbLoginComponent } from './components';
import { NbRegisterComponent } from './components';
import { NbLogoutComponent } from './components';
import { NbRequestPasswordComponent } from './components';
import { NbResetPasswordComponent } from './components';
